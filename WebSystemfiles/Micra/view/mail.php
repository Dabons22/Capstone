...
<form id="send" enctype="multipart/form-data" >
   ...
   <label for="firstname" class="form-label">Enter Name </label>
        <input type="textname" name="name" id="name" class="form-control" placeholder="Enter Name"  required=""> 
    </div>
    <div class="form-group">
    <label for="email" class="form-label">Enter Email Address &nbsp</label>
  <input type="texttt" name="email" id="email" class="form-control"  placeholder="Email address" required>
  ...
  <select id="subb" name="subject" required>
    ...
    <div >
        ...
        <button type="submit" name="submit" id="submit" class="button button2"value="SEND EMAIL"><i class="fa fa-paper-plane fw-fa"></i> SEND EMAIL  </button>
