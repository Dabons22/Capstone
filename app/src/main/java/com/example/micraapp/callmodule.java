...
public class callmodule extends drawerbase {
    ...
    private void setcontact() {
        ...
        contact.add(new calllistemergency("FIRE STATION", "09287604604", "#fd6967", imageicon[1]));
        contact.add(new calllistemergency("BARANGAY STATION", "0959845210", "#FFFDD1", imageicon[3]));
        contact.add(new calllistemergency("HOSPITAL STATION", "09454703749", "#AFAFAF", imageicon[2]));
        contact.add(new calllistemergency("POLICE STATION", "09531739102", "#1AA7EC", imageicon[0]));
